...
$(window).on("scroll",function(){
    ...
    $("#mobile-header")[pos>=300 ? "addClass" : "removeClass"]("on");

    $(".practices-title")[pos>=400 ? "addClass" : "removeClass"]("on");

    $("#pc-header")[pos>=400 ? "addClass" : "removeClass"]("up");

    $("#success-all")[pos>=700 ? "addClass" : "removeClass"]("on");

    $(".board-top")[pos>=900 ? "addClass" : "removeClass"]("on");

    $("table")[pos>=950 ? "addClass" : "removeClass"]("on");

    $(".pro-contents")[pos>=2000 ? "addClass" : "removeClass"]("on");
    $("#pro-btn")[pos>=2000 ? "addClass" : "removeClass"]("on");
